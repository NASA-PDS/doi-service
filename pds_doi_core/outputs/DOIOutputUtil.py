...
class DOIOutputUtil:
    ...
    def _CountExistingChildrenWithSameTag(self,name_index,num_existing_authors,my_parent,last_token):
        ...
        function_name = self.m_module_name + '_CountExistingChildrenWithSameTag:';
        global m_debug_mode;
    ...
    def PopulateListValuesWithValues(self,i_doc,attr_xpath,i_value):                                      
        ...
        function_name = self.m_module_name + 'PopulateListValuesWithValues:';
        ...
        if fourth_token_from_last == 'record' and third_token_from_last in list_of_tags_to_process_2 and last_token in list_of_tags_to_process:
            ...
            for name_index,name_value in enumerate(i_value):
                ...
                num_existing_last_tag = self._CountExistingChildrenWithSameTag(name_index,num_existing_authors,my_parent,last_token);
    ...
    #------------------------------                                                                                                 
    #------------------------------                                                                                                 
    def PopulateDOIXMLWithValues(self,dict_fixedList, xmlText, attr_xpath, i_value):                                      
        ...
        function_name = self.m_module_name + 'PopulateDOIXMLWithValues:';
        global m_debug_mode;
        ...
        if len(doc.xpath(attr_xpath)) == 0:
            ...
            doc = self.PopulateListValuesWithValues(doc,attr_xpath,i_value);
