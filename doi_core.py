...
#------------------------------                                                                                                 
#------------------------------                                                                                                 
def PopulateDOIXMLWithValues(dict_fixedList, xmlText, attr_xpath, value):                                      
...
#------------------------------
#------------------------------
def ReturnDOIDate(f_debug, debug_flag, prodDate):
#------------------------------
...
def DecodeBytesToString(xmlContent):
    o_string = None;
...
#------------------------------
#------------------------------
def ReturnNameSpaceDictionary(f_debug, debug_flag, xmlFile,xmlContent=None):
#------------------------------
...
#------------------------------
    ...
    if (xmlContent is not None):
        ...
        xmlContent_as_string = DecodeBytesToString(xmlContent);
...
#------------------------------                                                                                                 
def ProcessIAD2ProductLabelMetadata(dict_fixedList, dict_ConditionData, eachFile, FileName, xmlContent=None):
    ...
    dict_namespaces = ReturnNameSpaceDictionary(f_debug, debug_flag, eachFile,xmlContent)
    if m_debug_mode:
    ...
    try:  
        ...
        if os.path.isfile(eachFile):
            ...
            if xmlContent is not None:
                from io import StringIO; # for Python 3
                string_to_walk = DecodeBytesToString(xmlContent);   # The content may be a bunch of bytes.
        ...
        for event, element in context:
            ...
            parentNode = ProcessParentNode(parentNode,pds_uri_string,element,event);
...
#------------------------------                                                                                                 
#------------------------------                                                                                                 
def ProcessDOIMetadata(dict_configList, dict_fixedList, dict_ConditionData, FileName, list_keyword_values, DOI_filepath,publisher_value=None,contributor_value=None):
    ...
    for key, value in dict_value.items():
        ...
        if m_debug_mode:
            ...
            print(function_name,'INSPECT_VARIABLE:value[',value,']');
        xmlDOI_Text = PopulateDOIXMLWithValues(dict_fixedList, xmlDOI_Text, attr_xpath, value)                          
    ...
    xmlDOI_Text = PopulateDOIXMLWithValues(dict_fixedList, xmlDOI_Text, attr_xpath, publisher_value)
    if m_debug_mode:
    ...
    xmlDOI_Text = PopulateDOIXMLWithValues(dict_fixedList, xmlDOI_Text, attr_xpath, contributor_value)
    ...
    #  -- each value must be separated by semi-colon
    #------------------------------   
    keyword_values = ReturnKeywordValues(dict_configList, list_keyword_values);
    ...
    xmlDOI_Text = PopulateDOIXMLWithValues(dict_fixedList, xmlDOI_Text, attr_xpath, keyword_values)                          
...
#------------------------------                                                                                                 
#------------------------------                                                                                                 
def ReturnKeywordValues(dict_configList, list_keyword_values):                                              
#------------------------------                                                                                                 
#------------------------------                                                                                                 
...
def GetPermissibleValues(json_value_1,json_key_1):
...
def ValidateContributorValue(target_url,i_contributor):
    ...
    for json_key, json_value in json_data[0].items():
        ...
        for json_key_1, json_value_1 in json_value.items():
            ...
            o_permissible_value_list = GetPermissibleValues(json_value_1,json_key_1);
...
def ProcessParentNode(previous_parent,pds_uri_string,element,event):
...
def ParsePDS4LabelViaURI(target_url,publisher_value,contributor_value):
    ...
    dict_configList = {}                                                                                                            
    dict_fixedList  = {}
    (dict_configList, dict_fixedList) = GetConfigFileMetaData(xmlConfigFile)
    ...
    (dict_ConditionData, list_keyword_values) = ProcessIAD2ProductLabelMetadata(dict_fixedList, dict_ConditionData, eachFile, FileName,xmlBytes);
    ...
    o_doi_label = ProcessDOIMetadata(dict_configList, dict_fixedList, dict_ConditionData, key, list_keyword_values, DOI_filepath,publisher_value,contributor_value)
...
if __name__ == '__main__':
    ...
    (o_contributor_is_valid_flag,o_permissible_contributor_list) = ValidateContributorValue(DOI_CORE_CONST_PUBLISHER_URL,contributor_value);
    ...
    if action_type == 'create_osti_label':
        ...
        if target_url.startswith('http'):
            o_doi_label = ParsePDS4LabelViaURI(target_url,publisher_value,contributor_value);
            type_is_valid = True;
