Feature: create a draft OSTI DOI
  ...
  Scenario Outline: Verify reference draft transactions match
    ...
    Examples: reference draft transactions
      ...
      | aaDOI_production_submitted_labels/IMG_MRO_Bundle_20200814         | img        | aaaSubmitted_by_IMG_active_2020813               | aaaRegistered_by_EN_active_20200813/aaaSave_original/DOI_registered_all_records.xml |
