Feature: create a draft OSTI DOI
  ...
  Scenario Outline: Create a draft DOI from a valid PDS4 label <output_type> at <input_value>
    ...
    Examples: Valid PDS4 labels
      ...
      | bundle                 | img | https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/bundle.xml                             | OSTI        | tests/data/valid_bundle_doi.xml     |
      | data collection        | img | https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/data/collection_data.xml               | OSTI        | tests/data/valid_datacoll_doi.xml   |
      | browse collection      | img | https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/browse/collection_browse.xml           | OSTI        | tests/data/valid_browsecoll_doi.xml |
      | calibration collection | img | https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/calibration/collection_calibration.xml | OSTI        | tests/data/valid_calibcoll_doi.xml  |
      | document collection    | img | https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/document/collection_document.xml       | OSTI        | tests/data/valid_docucoll_doi.xml   |
