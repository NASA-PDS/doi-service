...
class MyTestCase(unittest.TestCase):
    ...
    # As of 06/30/2020, OSTI has the below DOI records
    # (['10.17189/21938','10.17189/21939','10.17189/21940'])
    # in their test server so this test will work to demonstrate that they have
    # new status of 'Reserved'. If for some reason the server has been wiped
    # clean, this unit test will still run but won't show any status changed.
    ...
    def setUp(cls):
        ...
        _database_obj.write_doi_info_to_database(
    ...
    def test_1(self):
        # Note that if the status return 'Error', is OK depending on what the
        # server has for the following 3 dois: ['10.17189/21938','10.17189/21939','10.17189/21940']
        logger.info("test making a query to database and update any status "
                    "changed from 'Pending' to something else. This test would "
                    "only work if the authentication for OSTI has been set up.")
