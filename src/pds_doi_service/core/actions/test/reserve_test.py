...
class ReserveActionTestCase(unittest.TestCase):
    ...
    def test_remote_pds4_bundle(self):
        ...
        input_url = "https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/bundle.xml"
    ...
    def test_reserve_remote_collection(self):
        ...
        input_url = "https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/data/collection_data.xml"
    ...
    def test_reserve_remote_browse_collection(self):
        ...
        input_url = "https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/browse/collection_browse.xml"
    ...
    def test_reserve_remote_calibration_collection(self):
        ...
        input_url = (
            "https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/calibration/collection_calibration.xml"
        )
    ...
    def test_reserve_remote_document_collection(self):
        ...
        input_url = "https://planetarydata.jpl.nasa.gov/img/data/nsyt/insight_cameras/document/collection_document.xml"
