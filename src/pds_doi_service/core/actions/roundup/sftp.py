...
from pds_doi_service.core.actions.roundup.enumerate import get_start_of_local_week, fetch_dois_modified_between, \
    get_previous_week_metadata
...
def run(database: DOIDataBase, sftp_host: str, sftp_user: str, sftp_password: str, sftp_port: int = 22,
