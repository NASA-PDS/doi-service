...
class LabelPayload(Model):
    ...
    """
    def __init__(self, status=None, title= None, publication_date=None,
                 product_type_specific=None, author_last_name=None,
                 author_first_name=None, related_resource=None):  # noqa: E501
